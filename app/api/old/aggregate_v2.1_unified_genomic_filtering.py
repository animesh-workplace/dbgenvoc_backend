...
Enhanced aggregation API with unified genomic position and pathway filtering.
...
async def generic_aggregate(
    ...
    Example 1: Count by gene in genomic range
    {
      "column": "gene",
    ...
    Example 2: Count at multiple positions (hotspots)
    {
    ...
    Example 4: Multi-gene analysis (NEW!)
    {
      "column": "variant_class",
      "aggregation_type": "count",
    ...
    Example 5: Exon + splice sites (NEW!)
    {
      "column": "variant_class",
      "aggregation_type": "count",
      "group_by": ["variant_class"],
...
"""
Example 1: Count by gene in TP53 region
----------------------------------------
{

...
- Genomic position filtering (unified - ranges and exact positions)
- Pathway filtering
...
class SearchRequest(BaseModel):
    ...
    # --- 1b. Genomic Position Filters (UNIFIED) ---
...
class SearchResponse(BaseModel):
    ...
    genomic_filter_applied: bool
    genomic_positions_count: Optional[int] = Field(
        None, 
        description="Number of genomic positions/ranges in the filter"
    )
...
async def generic_search(table_name: str, request: SearchRequest, db) -> SearchResponse:
    ...
    Example 1: Single genomic range
    {
      "genomic_filter": {
        "positions": [
    ...
    Example 2: Multiple exact positions (hotspots)
    {
      "genomic_filter": {
        "positions": [
          {"chromosome": "chr17", "start": 7577538},
    ...
    Example 3: Mixed ranges and positions (NEW!)
    {
      "filters": {
    ...
    Example 5: Exon + splice sites
    {
      "genomic_filter": {
        "positions": [
          {"chromosome": "chr17", "start": 7577019, "end": 7577155},  // Exon 5
          {"chromosome": "chr17", "start": 7577156},                   // Splice donor
          {"chromosome": "chr17", "start": 7577018}                    // Splice acceptor
        ]
      }
    }

    Example 6: Pathway filter with positions
    {
      "genomic_filter": {
        "positions": [
          {"chromosome": "chr17", "start": 7577000, "end": 7579000}
    ...
    Example 7: Combined with text search and structured filters
    {
      "filters": {
        "conditions": [
    ...
    try:
        ...
        # Calculate genomic positions count for response
...
"""
Example 1: Single Range (Equivalent to old 'region')
-----------------------------------------------------
{
...
Example 2: Multiple Hotspot Positions
--------------------------------------
{
  "table": "nibmg_exome_somatic_variants",
  "genomic_filter": {
    "positions": [
      {"chromosome": "chr17", "start": 7577538},  // R175H
      {"chromosome": "chr17", "start": 7577548},  // R213H
      {"chromosome": "chr17", "start": 7578406}   // R248Q
    ]
  }
}

Example 3: Mixed - Regulatory Region + Hotspots (NEW!)
-------------------------------------------------------
{
  "table": "nibmg_exome_somatic_variants",
  "genomic_filter": {
    "positions": [
      {"chromosome": "chr17", "start": 7571000, "end": 7572000},  // Regulatory
      {"chromosome": "chr17", "start": 7577538},                   // R175H
      {"chromosome": "chr17", "start": 7578406}                    // R248Q
    ]
  }
...
Example 5: Multi-Gene Analysis (NEW!)
--------------------------------------
{
  "table": "nibmg_exome_somatic_variants",
  "genomic_filter": {
    "positions": [
      {"chromosome": "chr17", "start": 7577000, "end": 7579000},   // TP53
      {"chromosome": "chr13", "start": 32889611, "end": 32973805}, // BRCA2
      {"chromosome": "chr11", "start": 534289}                      // HBB hotspot
    ]
  }
}

Example 6: Pathway + Positions
-------------------------------
{
  "table": "nibmg_exome_somatic_variants",
  "filters": {
...
Example 7: Complex Query with All Filters
------------------------------------------
{
  "table": "nibmg_exome_somatic_variants",
  "filters": {
    ...
    "conditions": [
      {"column": "variant_class", "operator": "eq", "value": "Missense_Mutation"},
      {"column": "impact", "operator": "in", "value": ["HIGH", "MODERATE"]}
    ]
  },
  "genomic_filter": {
    "positions": [
